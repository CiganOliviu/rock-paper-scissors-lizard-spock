/*
   ...
   Copyright [Cigan Oliviu David] [name of copyright owner]
...
class validarionRules {
    ...
    public static boolean isNotComponent (String component) {
        ...
        if (component.equals("rock"))
            return false;

        if (component.equals("paper"))
            return false;

        if (component.equals("scissors"))
            return false;

        if (component.equals("lizard"))
            return false;

        if (component.equals("spock"))
            return false;
...
class componentsAbilities {
    ...
    public static boolean rockVictims (String component) {

        if (component.equals("scissors")) return true;
        if (component.equals("lizard")) return true;

        return false;
    }

    public static boolean scissorsVictims(String component) {

        if (component.equals("lizard")) return true;
        if (component.equals("paper")) return true;

        return false;
    }

    public static boolean spockAVictims(String component) {

        if (component.equals("rock")) return true;
        if (component.equals("scissors")) return true;

        return false;
    }

    public static boolean lizardVictims(String component) {

        if (component.equals("paper")) return true;
        if (component.equals("spock")) return true;

        return false;
    }

    public static boolean paperVictims(String component) {
